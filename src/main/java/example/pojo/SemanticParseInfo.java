...
import example.pojo.DateConf;
import example.pojo.Order;
import example.pojo.enums.AggregateTypeEnum;
import example.pojo.enums.FilterType;
import example.pojo.enums.QueryType;
import example.pojo.enums.SchemaElementType;
import example.pojo.request.QueryFilter;
...
import static example.pojo.Constants.DEFAULT_DETAIL_LIMIT;
import static example.pojo.Constants.DEFAULT_METRIC_LIMIT;
